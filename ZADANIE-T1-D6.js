...
const TOKEN_TELEMETRII = "";
...
*/
odpowiedź("A");
uzasadnienie(`Typy danych to np string object, albo array - są one klasyfikowane np jako ciąg liter czyli string (czyli cecha to np to ze sklada sie z liter) albo {} jako obiekt którego zachowania np różnią się od stringa.`);
...
*/
odpowiedź("const");
uzasadnienie(`Użyję const bo np let tworzy tzw. zmienną która się może zmienić a const z ang constans czyli stała to sie nie zmieni`);
...
*/
odpowiedź("undefined");
uzasadnienie(`Szczerze to nie czaje a odpowiedź wpisałem na czuja. EDIT: Pomogłem sobie internetem i wiem teraz że f nie ma wartości o, teraz troche bardziej rozumiem ale sam bym nie ogarnął`);
...
*/
odpowiedź("B");
uzasadnienie(`Proste - pętla jak sama nazwa wskazuje to zapętlanie czynności czyli jej powtarzanie. Nie potrzebujemy pętli żeby skorzystać z opcji podanych w innych odpowiedziach`);
...
*/
odpowiedź("5");
uzasadnienie(`No generalnie to obliczyłem w pamięci i wyszło mi że mogę zmieniać "i" 5 razy aż będzie większe od 100. Wcześniej nie wiedziałem jak działa dokładnie kod - myślałem że wykonuje się on dopiero po i=i*2 i wtedy pierwsza liczba to by było 10 więc xNzq by sie pojawiło 4 razy`);
...
*/
odpowiedź("1010");
uzasadnienie(`No generalnie to podchwytliwe i udało mi się na to odpowiedzieć bo źle odpowiedziałem na pytanie 3 i tam w dokumentacji było że kod może wymusić zmianę typu klasyfkacji i tutaj kod "wymusił" zmianę b na stringa`);
...
*/
odpowiedź("4");
uzasadnienie(`No generalnie to chciałem wpisać 5 ale przypadkowo wpisałem 4 i siadło xD Wydaje mi się że to dlatego iż b jest wartością stałą która nie równa się 10. EDIT: poszukałem w necie (zapytałem dzepetta) i juz wiem ze powinno byc jak juz b=o bo skoro to to samo to czemu b ma się równać wartości przypisanej do obiektu a nie samemu obiektowi.`);
...
uzasadnienie(`No tak sie wywołuje funkcje proste chyba`);
...
uzasadnienie(`W ten sposób się odczytuje klucze z obiektów`);
...
uzasadnienie(`9 bo zaczyna się od 0`);
...
/*
    ...
    Odpowiedź wpisz poniżej.
*/
odpowiedź("nieskonczonosc");
uzasadnienie(`i to bedzie ciagle 0`);
